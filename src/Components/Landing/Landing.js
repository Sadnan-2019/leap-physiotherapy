            ...
            <div className=" md:py-20 py-10 lg:py-24 lg:mx-16 mx-8 grid lg:grid-cols-1 grid-cols-1 gap-5">
              <div className="sm:max-w-xs lg:max-w-xl text-left md:ml-8 lg:order-1 order-2   lg:mt-0">
                ...
                <p
                  ...
                  style={{ lineHeight: "120%", color: "#CB052F" }}
                >
                  Our highly qualified and experienced teams use the most
                  up-to-date techniques to swiftly and smoothly repair your
                  body, with the goal of long-term wellness
                </p>
