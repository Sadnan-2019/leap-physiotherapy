    ...
    <div>
      <div className="py-10">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 px-0   lg:px-12 gap-10    py-[25px] items-center justify-items-center ">
          <div
            className="shadow-2xl shadow-blue-800 hover:  transition duration-500 hover:scale-110  bg-gradient-to-r from-[#034ca7]  to-[#2622B7] h-4/5 lg:h-3/4     w-screen	 lg:w-5/6  flex items-center justify-center  	 gap-5      border    p-10"
          ...
          <div
            className="hover:  transition duration-500 hover:scale-110 shadow-2xl shadow-blue-800  bg-gradient-to-r from-[#034ca7]  to-[#2622B7]  h-4/5 lg:h-3/4     w-screen	 lg:w-5/6    flex items-center justify-center	 gap-5       border   p-10"
            style={{
              borderRadius: "25px",
            }}
          >
