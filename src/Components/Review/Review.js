      ...
      <div className="container mx-auto px-4 lg:px-10">
        ...
        >
          ...
          <p className="mt-6 text-base lg:text-lg text-gray-600 leading-8 max-w-4xl mx-auto">
            Discover why patients trust <strong>L.E.A.P Physiotherapy &
            Rehabilitation</strong> for evidence-based physiotherapy, sports
            injury rehabilitation, stroke rehabilitation, back pain treatment,
            knee pain treatment and personalized recovery programs. Every
            success story reflects our commitment to helping patients reduce
            pain, restore movement and improve their quality of life.
          </p>
        </div>
