...
const Rehabilitation = () => {
  return (
    <div>
      <Helmet>
        <title> Rehabilitation At Gulshan</title>
        <meta
          name="description"
          content="Rehabilitation gives good results for acute and chronic pain by modifying the impulse, leading to pain relief."
        />
        <meta
          name="keywords"
