...
const TherapeuticExercise = () => {
  return (
    <div>
      <Helmet>
        <title> TherapeuticExercise At Gulshan</title>
        <meta
          name="description"
          content="TherapeuticExercise gives good results for acute and chronic pain by modifying the impulse, leading to pain relief."
        />
        <meta
          name="keywords"
