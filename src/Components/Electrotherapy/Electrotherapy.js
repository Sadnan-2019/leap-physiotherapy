...
const Electrotherapy = () => {
  return (
    <div>
      <Helmet>
              <title> Electrotherapy At Gulshan</title>
              <meta
                name="description"
                content="Electrotherapy gives good results for acute and chronic pain by modifying the impulse, leading to pain relief."
              />
              <meta
                name="keywords"
