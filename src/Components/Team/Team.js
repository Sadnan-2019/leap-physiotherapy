...
const Team = () => {
  return (
    <div className="  mb-10   bg-gradient-to-r from-[#034ca7]  to-[#5f7499]">
      ...
      <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-5 px-8    " data-aos="fade-right"
            data-aos-duration="1000">
        <div class="flex      bg-gradient-to-br  ">
          <div class="overflow-hidden   aspect-video h-96 cursor-pointer rounded-xl relative group">
            <div class="sm:w-full lg:w-full rounded-xl z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end">
              <div>
        ...
        <div class="flex     bg-gradient-to-br  ">
          <div class="overflow-hidden   aspect-video h-96 cursor-pointer rounded-xl relative group">
            ...
            <img
              alt=""
              class="object-cover  w-full h-56  aspect-square group-hover:scale-110 transition duration-300 ease-in-out"
